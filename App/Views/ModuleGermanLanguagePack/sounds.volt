...
<div class="ui segment">
    <a class="ui basic compact button"
       href="{{ url('module-german-language-pack/module-german-language-pack/index') }}">
        <i class="left arrow icon"></i>{{ t._('mlp_de_BackToOverview') }}
    </a>
    ...
    <div id="languagepack-sounds-table-container" style="margin-top: 1em;">
        <table class="ui selectable compact unstackable table" id="languagepack-sounds-table">
            <thead>
                <tr>
                    <th>{{ t._('mlp_de_ColumnFile') }}</th>
                    <th class="cdr-player-column">{{ t._('mlp_de_ColumnPlayer') }}</th>
                    <th>{{ t._('mlp_de_ColumnConverted') }}</th>
                    <th></th>
                </tr>
            </thead>
            <tbody></tbody>
