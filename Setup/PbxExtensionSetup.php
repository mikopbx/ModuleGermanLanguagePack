...
namespace Modules\ModuleGermanLanguagePack\Setup;
 ...
 * PbxExtensionSetup
 *
 * Setup class for German Language Pack Module
 *
 * This Language Pack module provides automatic installation of:
 * - German UI translations from Messages/de/ directory
 * - German voice prompts from Sounds/de-de/ directory
 *
 ...
 *
 * @package Modules\ModuleGermanLanguagePack\Setup
 */
class PbxExtensionSetup extends PbxExtensionSetupBase
{
     ...
     */
    protected string $moduleUniqueID = 'ModuleGermanLanguagePack';

    /**
     * Additional actions before module installation
     *
     * For Language Pack modules, we check for conflicts with other German packs.
    ...
    public function onBeforeModuleEnable(): bool
    {
        ...
        if ($conflictModule !== null) {
            $this->messages[] = "Cannot install: Another German Language Pack ($conflictModule) is already installed. Please uninstall it first.";
            return false;
        }
    ...
    public function onAfterModuleEnable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'German Language Pack installed successfully',
            LOG_INFO
        );
    ...
    public function onBeforeModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Uninstalling German Language Pack',
            LOG_INFO
        );
    ...
    public function onAfterModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'German Language Pack uninstalled successfully',
            LOG_INFO
        );
