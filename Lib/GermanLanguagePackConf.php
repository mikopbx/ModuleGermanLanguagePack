...
namespace Modules\ModuleGermanLanguagePack\Lib;

use MikoPBX\Modules\Config\ConfigClass;
use Modules\ModuleGermanLanguagePack\Lib\RestAPI\Controllers\SoundsController;

/**
 * GermanLanguagePackConf
 *
 * Wires the per-module REST endpoints (sounds inventory + conversion progress).
 */
class GermanLanguagePackConf extends ConfigClass
{
    public const string ROUTE_PREFIX = '/pbxcore/api/v3/module-german-language-pack';
